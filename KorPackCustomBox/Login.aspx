<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Login.aspx.cs" Inherits="StringEncodeDecode._Login" ResponseEncoding="Unicode" Title="Royal Flowers: Login" %>
    ...
    <form id="form1" runat="server" defaultbutton="btnLogin">
        <div class="loginBody">
            ...
            <div style="vertical-align: bottom;text-align:right;padding-right: 35px;">
                <a id="A2" style="color:white; display:none" href="RetrievePassword.aspx">Forgot Password?</a>
            </div>
        </div>
