    ...
    <div class="container">
        <div class="panel panel-primary">
            <div class="panel-heading">
                <h3 class="panel-title">Manage User <a id="A1" class="thickbox specialLink btn btn-primary btn-xs pull-right" href="NewUser.aspx?TB_iframe=true&height=480&width=700&modal=true"><i class="fa fa-plus"></i> New User</a></h3>
            </div>
            <div class="panel-body">
                ...
                <div class="configurationPage">
                    ...
                    <table class="cssTableTwo" style="display: none">
                        ...
                        <tr>
                            <td class="style1">Confirm Password
                            </td>
                            <td class="style2">
                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        <ContentTemplate>
                            <asp:GridView ID="grdEmpInfo" runat="server" AutoGenerateColumns="False" OnRowCancelingEdit="grdEmpInfo_RowCancelingEdit"
                                ...
                                CssClass="gridview display table table-striped table-bordered table-responsive"
                                 AlternatingRowStyle-CssClass="gridviewaltrow" OnRowDataBound="grdEmpInfo_RowDataBound">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Login Info">
                                        ...
                                        <EditItemTemplate>
                                            ...
                                            <table width="100%">
                                                <tr>
                                                    <td width="30%" bgcolor="silver" align="left">Name of User
                                                    </td>
                                                ...
                                                <tr>
                                                    <td width="30%" bgcolor="silver" align="left">Login ID
                                                    </td>
                                                    <td width="70%" align="left">
                                                ...
                                                <tr>
                                                    <td width="30%" bgcolor="silver" align="left">Password
                                                    </td>
                                                    <td width="70%" align="left">
                                                ...
                                                <tr>
                                                    <td width="30%" bgcolor="silver" align="left">Conf. Password
                                                    </td>
                                                    <td width="70%" align="left">
                ...
                <div id="allHiddenField">
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Cnn %>"
                        SelectCommand="SELECT RoleID, RoleDesc FROM (SELECT RoleID, RoleDesc,company_id FROM TB_PrmUserRole) AS TBL ORDER BY RoleDesc"></asp:SqlDataSource>
